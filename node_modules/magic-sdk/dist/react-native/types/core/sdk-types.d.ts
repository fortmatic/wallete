...
export declare type MagicSDKReactNativeAdditionalConfiguration<TCustomExtName extends string = string, TExt extends Extension<string>[] | {
    [P in TCustomExtName]: Extension<string>;
} = any> = Omit<MagicSDKAdditionalConfiguration<TCustomExtName, TExt>, 'endpoint'>;
